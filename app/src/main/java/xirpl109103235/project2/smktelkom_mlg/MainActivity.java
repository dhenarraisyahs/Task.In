        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.action_play:
                    ...
                    text_to_speech = "Your task is " + tasklist.getDescription();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_upload:
                ...
                return true;
            case R.id.action_greetings:
                text_to_speech = "Welcome users! we help you to note your task! just add it and press play to listen to your task, don't forget to click upload after making the task!. regards, Creator";
                WatsonTask task = new WatsonTask();
                task.execute();
                return true;
            default:
